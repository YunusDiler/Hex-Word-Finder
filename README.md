...
**Word Master** ve benzeri hexagonal grid Türkçe kelime bulmaca oyunları için yardımcı masaüstü uygulaması. Tahtadaki harflerden oluşturulabilecek tüm geçerli Türkçe kelimeleri **Trie + DFS** ile hızlıca bulur.

![Python](https://img.shields.io/badge/Python-3.9%2B-blue?logo=python) ![Tkinter](https://img.shields.io/badge/GUI-Tkinter-orange)
...
- Türkçe karakterlerin tamamı desteklenir (Ç, İ, Ş, Ö, Ç, Ü)
- Kelime veritabanı Trie'a yüklenir
...
Repodaki `tdk.txt` dosyası TDK Güncel Türkçe Sözlük'ten derlenmiştir.
